 ...
 * 
 * - Added tooltips
 * - Fixed collisions with disables proximity speed
 */
...
public class IVR_Walking : MonoBehaviour {
    ...
    [Tooltip("is forward / backward walking enabled?")]
	public bool walking = true;
    [Tooltip("is left / right sidestepping enabled?")]
    public bool sidestepping = true;
    [Tooltip("is body rotation enabled?")]
	public bool rotating = false;
    [Tooltip("Determines the rotation speed")]
	public float rotationSpeedRate = 60;

    [Tooltip("the walking speed is dependent on the proximity of objects")]
	public bool proximitySpeed = true;
    [Tooltip("the amount of influence.\n1 = no influence on speed\n0 = maximum.")]
	...
	private Vector3 CheckMovement() {
		...
		if (curProximitySpeed <= 0.15f  || (!proximitySpeed && ivr.hit)) {
