...
public class IVR_BodyMovements: MonoBehaviour {
    ...
    private ArmMovements leftArm, rightArm;
    private Torso torso;
...
public class ArmMovements {
    ...
    public void CalculateFromNormTPose() {
        Transform thumbProximal, indexProximal;
        ...
        fromNormHand = Quaternion.Inverse(Quaternion.LookRotation(indexProximal.position - hand.position, hand.position - thumbProximal.position)) * hand.rotation;
    }
	...
	public void Calculate(Transform handTarget) {
		if (handTarget != null) {
            ...
            hand.rotation = handTarget.rotation * fromNormForearm;
        }
	}
}
